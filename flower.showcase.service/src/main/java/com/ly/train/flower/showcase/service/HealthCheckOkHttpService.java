 ...
 */
@FlowerService
public class HealthCheckOkHttpService extends AbstractService<HttpAsyncReq, CompletableFuture<String>> {
  ...
  public CompletableFuture<String> doProcess(HttpAsyncReq message, ServiceContext context) throws Throwable {
    ...
    return HttpFactory.okHttpFactory.get(requestContext);
  }
